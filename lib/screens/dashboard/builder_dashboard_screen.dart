...
class BuilderDashboardScreen extends StatefulWidget {
  const BuilderDashboardScreen({super.key});

  @override
  State<BuilderDashboardScreen> createState() =>
      _BuilderDashboardScreenState();
}

class _BuilderDashboardScreenState extends State<BuilderDashboardScreen> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 30),
                        _sectionTitle(context, "Recent Projects", Icons.apartment_rounded),
                        const SizedBox(height: 16),
                        _recentProjectsCard(context, auth),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Flexible(
                                          child: Text(
                                            auth.userName.isNotEmpty ? auth.userName : "Builder",
                                            style: textTheme.titleLarge?.copyWith(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w800,
                                              letterSpacing: -0.3,
  ...
  Widget _buildPerformanceOverview(
    ...
    final totalProjects = stats.totalProjects;
    final completionRate = totalProjects > 0
        ? (stats.deliveredProjects / totalProjects).clamp(0.0, 1.0)
        : 0.0;
    final activeRate = totalProjects > 0
        ? (stats.activeProjects / totalProjects).clamp(0.0, 1.0)
        : 0.0;
      ...
      child: Column(
        ...
        children: [
          ...
          _progressRow(
            ...
            trailing: "${stats.deliveredProjects}/$totalProjects",
          ),
          ...
          _progressRow(
            ...
            trailing: "${stats.activeProjects}/$totalProjects",
          ),
          const SizedBox(height: 24),
  ...
  // Wraps the existing BuilderQuickActionsWidget in a premium container
  ...
  Widget _quickActionsCard(BuildContext context) {
    return Container(
      ...
      child: const BuilderQuickActionsWidget(),
    );
  }

  // ---------------- RECENT PROJECTS WRAPPER CARD ----------------
  // Wraps the existing BuilderRecentProjectsWidget in a premium container
  // without altering its internal logic.

  Widget _recentProjectsCard(BuildContext context, AuthProvider auth) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(18),
      decoration: BoxDecoration(
      ...
      child: BuilderRecentProjectsWidget(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                "Your latest updates and milestones\nwill show up here.",
                textAlign: TextAlign.center,
                style: textTheme.bodySmall?.copyWith(
