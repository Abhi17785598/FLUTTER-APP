...
class PlanFeatures {
  ...
  static const List<FeatureAccess> _free = [
    FeatureAccess(Icons.apartment_rounded, '5 active property listings',
        included: true),
    FeatureAccess(Icons.visibility_outlined,
        'Track property views and basic enquiries',
        included: true),
    FeatureAccess(Icons.headset_mic_outlined,
        'Standard email support (48hr response)',
        included: true),
    FeatureAccess(
        Icons.phone_iphone, 'Mobile app access for on-the-go management',
        included: true),
    FeatureAccess(Icons.track_changes,
        'Priority placement across premium property searches',
        included: false),
    FeatureAccess(Icons.article_outlined,
        'Generate SEO-optimized property descriptions using AI',
        included: false),
    FeatureAccess(
        Icons.headset_mic_outlined, 'Priority builder support channel',
        included: false),
    FeatureAccess(
        Icons.verified_user_outlined, 'Verified builder badge for credibility',
        included: false),
    FeatureAccess(Icons.trending_up_rounded,
        'Advanced conversion and sales performance insights',
        included: false),
    FeatureAccess(
        Icons.article_outlined, 'Custom branding & white-label solution',
        included: false),
  ];

  static const List<FeatureAccess> _pro = [
    FeatureAccess(Icons.apartment_rounded, '50 active property listings',
        included: true),
    FeatureAccess(Icons.visibility_outlined,
        'Track property views, enquiries, conversions and sales performance',
        included: true),
    FeatureAccess(
        Icons.headset_mic_outlined, 'Priority email support (24hr response time)',
        included: true),
    FeatureAccess(
        Icons.phone_iphone, 'Mobile app access for on-the-go management',
        included: true),
    ...
    FeatureAccess(Icons.article_outlined,
        ...
        included: true),
    FeatureAccess(
        Icons.headset_mic_outlined, '24/7 dedicated builder support channel',
        included: false),
    FeatureAccess(
        Icons.verified_user_outlined, 'Verified builder badge for credibility',
        included: false),
    FeatureAccess(
        Icons.trending_up_rounded, 'Custom branding & white-label solution',
        included: false),
    FeatureAccess(
        Icons.article_outlined, 'API access for custom integrations',
        included: false),
  ];

  static const List<FeatureAccess> _builder = [
    FeatureAccess(
        Icons.apartment_rounded, 'Unlimited active property listings',
        included: true),
    FeatureAccess(Icons.visibility_outlined,
    ...
    FeatureAccess(
        ...
        included: true),
    FeatureAccess(
        Icons.groups_outlined, 'Team collaboration tools for agencies',
        included: true),
    FeatureAccess(
        Icons.article_outlined, 'API access for custom integrations',
        included: true),
  ...
  static const List<FeatureAccess> _enterprise = [
    FeatureAccess(Icons.apartment_rounded,
    ...
    FeatureAccess(Icons.headset_mic_outlined,
        ...
        included: true),
    FeatureAccess(Icons.phone_iphone,
    ...
    FeatureAccess(Icons.article_outlined,
        'Generate SEO-optimized property descriptions using AI',
        included: true),
    FeatureAccess(Icons.verified_user_outlined,
        'Verified enterprise builder badge for credibility',
        included: true),
    FeatureAccess(
        Icons.trending_up_rounded, 'Custom branding & white-label solution',
        included: true),
    FeatureAccess(Icons.security_outlined,
  ...
  static int lockedCount(String plan) =>
      totalCount(plan) - includedCount(plan);
}
